...
function App() {
  ...
  React.useEffect(() => {
    async function fetchData() {
      const cartResponse = await axios.get('https://62d970bf9eedb699635c3307.mockapi.io/cart')
      const favoritesResponse = await axios.get('https://62d970bf9eedb699635c3307.mockapi.io/favorites')
  ...
  const onAddToCart = (obj) => {
      if (cartItems.find(item => Number(item.id) === Number(obj.id))) {
        axios.delete(`https://62d970bf9eedb699635c3307.mockapi.io/cart/${obj.id}`)
